...
from .views import ProjectView , SubProjetView , ProjectDataView , SubProjectReport , AllSubprojectReport , CheckBoxSubProject
...
urlpatterns = [
    ...
    path('checkboxsubproject/', CheckBoxSubProject.as_view()),
